Stages.Stage3 = class Stage3 extends GameClasses.Stage {
    ...
    addMap1() {
        ...
        this.addMap(map)
        let monster1 = new GameClasses.Monster(marbleDataList[11], {x: 190, y: 400}, 1)
        // let monster2 = new GameClasses.Monster(marbleDataList[19], {x: 930, y: 400}, 1)
        // let monster3 = new GameClasses.Monster(marbleDataList[15], {x: 190, y: 1100}, 1)
        // let monster4 = new GameClasses.Monster(marbleDataList[56], {x: 930, y: 1100}, 1)
    ...
    addMap2() {
        ...
        let monster3 = new GameClasses.Monster(marbleDataList[15], {x: 190, y: 1100}, 1)
        let monster4 = new GameClasses.Monster(marbleDataList[19], {x: 930, y: 1100}, 1)
        map.addMonster(monster1)
        map.addMonster(monster2)
        map.addMonster(monster3)
        map.addMonster(monster4)
